 ...
 * 创建自定义菜单的未封装版本
 */
exports._createMenu = function (agentid, menu, callback) {
  var url = this.prefix + 'menu/create?agentid=' + agentid + '&access_token=' + this.token.accessToken;
 ...
 * @param {Function} callback 回调函数
 */
exports.getMenu = function (agentid, callback) {
 ...
 * 获取自定义菜单的未封装版本
 */
exports._getMenu = function (agentid, callback) {
  var url = this.prefix + 'menu/get?agentid=' + agentid + '&access_token=' + this.token.accessToken;
 ...
 * @param {Function} callback 回调函数
 */
exports.removeMenu = function (agentid, callback) {
 ...
 * 删除自定义菜单的未封装版本
 */
exports._removeMenu = function (agentid, callback) {
  var url = this.prefix + 'menu/delete?agentid=' + agentid + '&access_token=' + this.token.accessToken;
  this.request(url, {dataType: 'json'}, wrapper(callback));
};
